...
export function EventCard({ event, index }: EventCardProps) {
    ...
    return (
        <motion.div
            ...
            whileHover={{ y: -4 }}
            className="bg-space-gray-900/80 backdrop-blur-sm border border-space-gray-700 hover:border-cosmic-purple/50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300"
        >
            {/* Event Icon & Name */}
            ...
            <div className="flex gap-2">
                ...
                <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="py-2 px-4 bg-space-gray-800 hover:bg-space-gray-700 text-star-white border border-space-gray-700 rounded-lg font-semibold text-sm transition-colors"
                >
                    Details
                </motion.button>
            </div>
